...
A beginner-friendly PyTorch / deep learning course, organized day by
...
| 2 | [`day02/`](day02/) | Autograd — automatic differentiation, `.backward()`, computational graphs |
| 3 | [`day03/`](day03/) | Building a model with `nn.Module` |
| 4 | [`day04/`](day04/) | Loss functions & optimizers |
| 5 | [`day05/`](day05/) | The training loop |
| 6 | [`day06/`](day06/) | Datasets & DataLoaders |
| 7 | [`day07/`](day07/) | Real image data — transforms & `ImageFolder` |
| 8 | [`day08/`](day08/) | Convolutional Neural Networks |
| 9 | [`day09/`](day09/) | Training a CNN end-to-end |
| 10 | `day10/` | Overfitting & regularization |
| 11 | `day11/` | Transfer learning |
| 12 | `day12/` | Saving, loading & checkpointing |
| 13 | `day13/` | GPU & mixed-precision training |
| 14 | `day14/` | Evaluation & metrics |
| 15 | `day15/` | Capstone: a full image classifier project |
...
```bash
git clone https://github.com/meharuhanzz/Pytorch-tutorial.git
cd Pytorch-tutorial/day01
python3 main.py
```
