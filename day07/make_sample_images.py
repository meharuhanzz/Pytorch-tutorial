...
to point ImageFolder at, without needing to download anything. Creates
three classes of small solid-colour-ish images with random noise --
nothing fancy, just enough for ImageFolder to load real files.
